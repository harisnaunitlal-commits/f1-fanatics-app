    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="card text-center flex flex-col items-center">
          ...
          <Link href="/ranking/play" className="text-f1red text-sm mt-3 block hover:underline">
            Ver ranking
          </Link>
        </div>
        ...
        <div className="card text-center flex flex-col items-center">
          {/* Logo → join link */}
          <a
            href="https://fantasy.formula1.com/en/leagues/join/C57XPPKP703"
            target="_blank"
            rel="noopener noreferrer"
            className="h-16 w-full flex items-center justify-center mb-3 hover:opacity-80 transition-opacity"
            title="Juntar à liga F1 Fantasy"
          >
          ...
          {/* League code highlighted */}
          <a
            href="https://fantasy.formula1.com/en/leagues/join/C57XPPKP703"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 px-3 py-1 rounded-lg bg-f1red/10 border border-f1red/30 hover:bg-f1red/20 transition-colors"
          >
            <span className="text-xs text-gray-400">Código: </span>
            <span className="text-sm font-black text-yellow-400 tracking-widest">C57XPPKP703</span>
          </a>
          <div className="text-xs text-gray-600 mt-1">fantasy.formula1.com</div>
        ...
        <div className="card text-center flex flex-col items-center">
          {/* Logo → join link */}
          <a
            href="https://f1predict.formula1.com/en/leagues/join/C4MIFTXAH05"
            target="_blank"
            rel="noopener noreferrer"
            className="h-16 w-full flex items-center justify-center mb-3 hover:opacity-80 transition-opacity"
            title="Juntar à liga F1 Predict"
          >
          ...
          >
            <span className="text-xs text-gray-400">Código: </span>
            <span className="text-sm font-black text-yellow-400 tracking-widest">C4MIFTXAH05</span>
          </a>
          <div className="text-xs text-gray-600 mt-1">f1predict.formula1.com</div>
